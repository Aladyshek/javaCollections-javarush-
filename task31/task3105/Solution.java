...
public class Solution {
    ...
    public static void addNewFileToZIP(File addedFile, File zipArchive) {
        ...
        try (ZipOutputStream zipOutputStream = new ZipOutputStream(new FileOutputStream(zipArchive)); FileInputStream fileInputStream = new FileInputStream(zipArchive)) {
